      ...
      <div className="p-8 md:p-12 flex items-center justify-center">
        <div className="w-full max-w-sm">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full rounded-lg border border-white/15 bg-white/5 px-3 py-2.5 text-sm text-white placeholder:text-white/25 focus:border-white/30 focus:outline-none transition-colors"
                {...register('email')}
              />
          ...
          <p className="mt-5 text-sm text-white/40">
            No account?{' '}
            <Link to="/register" className="text-white/70 hover:text-white underline transition-colors">Create one</Link>
          </p>
        </div>
      </div>
      <div className="hidden md:flex items-center justify-center bg-[#F6C913]">
