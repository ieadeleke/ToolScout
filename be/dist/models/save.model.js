...
const SaveSchema = new mongoose_1.Schema({
    ...
    tool_id: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Tool', required: true, index: true },
    created_at: { type: Date, default: Date.now },
});
SaveSchema.index({ user_id: 1, tool_id: 1 }, { unique: true });
exports.SaveModel = mongoose_1.default.models.Save || mongoose_1.default.model('Save', SaveSchema);
